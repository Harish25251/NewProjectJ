...
public class BaseClass {
	...
	public void getDriver(String browserType) {
		...
		case "Chrome":
			...
			System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\user\\eclipse-workspace\\NewProjectJunit\\Driver\\chromedriver.exe");
		...
		case "Edge":
			...
			System.setProperty("webdriver.edge.driver",
					"C:\\Users\\user\\eclipse-workspace\\NewProjectJunit\\Driver\\msedgedriver.exe");
	...
	public String excelRead(int rownum, int cellnum) throws IOException {
		...
		File fileLocation = new File("C:\\Users\\user\\Downloads\\ExcelRead.xlsx");
